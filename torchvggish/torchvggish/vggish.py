...
class VGGish(VGG):
    def __init__(self, urls, pretrained=True, preprocess=True, postprocess=True, progress=True):
        ...
        if pretrained:
            state_dict = hub.load_state_dict_from_url(urls['vggish'], progress=progress, model_dir='./checkpoint')
        ...
        if self.postprocess:
            ...
            if pretrained:
                state_dict = hub.load_state_dict_from_url(urls['pca'], progress=progress, model_dir="./checkpoint")
